...
from imager.infrastructure.data.image_builder.unit_of_work import MongoUnitOfWork
...
class TestGenerateImageCommandHandler(unittest.TestCase):
    ...
    @patch('imager.application.image_builder.commands.generate_image.get_uow')
    def test_handle_success(self, mock_get_uow):
        ...
        with patch('imager.application.image_builder.commands.generate_image.ImagerBuilder', return_value=mock_builder):
