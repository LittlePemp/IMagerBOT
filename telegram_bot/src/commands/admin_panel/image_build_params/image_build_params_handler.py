...
from src.commands.admin_panel.image_build_params.image_groups.image_groups_handler import register_handlers_image_groups
...
def register_handlers_image_build_params(dp: Dispatcher, uow: MongoUnitOfWork):
    ...
    register_handlers_image_groups(dp, uow)
